...
#   the model.
data_ = data.trim_time_series(n_embeddings=15, sequence_length=1000)
...
# This is to find frequency bands that have patterns of coherence activity
# See: Vidaurre, et al. https://www.nature.com/articles/s41467-018-05316-z
